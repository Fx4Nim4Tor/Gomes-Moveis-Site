...
from core.views import produto ,inicio, produtos,buscar,adm_dashboard,adm_login,adm_logout,adm_categoria_criar,adm_categoria_deletar,adm_categoria_editar,adm_categorias,adm_produtos, adm_produto_criar, adm_produto_editar, adm_produto_deletar,sobre
